...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|p{6.8cm}|c|p{5cm}|}
        \hline
        \rowcolor{gray!20}
        \textbf{Sprint} & \textbf{Fonctionnalités / Activités} & \textbf{Durée} & \textbf{Livrables} \\
        \hline
    ...
    \end{tabular}
    \caption{Planification par sprints du projet SafeTrack}
    \label{tab:plan_sprints}
\end{table}

Le Sprint 0 inclut désormais l'ensemble de la documentation des API REST, WebSocket et services internes, afin de garantir une base technique claire avant le développement des fonctionnalités métier.\section*{Conclusion}
