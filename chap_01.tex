...
\noindent\textbullet\ \textbf{FindMyKids}

Application mobile de surveillance pour enfants qui permet de suivre leur géolocalisation en temps réel, de définir des zones sécurisées (geofencing) et de recevoir des alertes en cas d'urgence ou de dépassement de zone. Elle offre aussi un historique des mouvements et des notifications spécifiques pour assurer la sécurité des enfants \cite{findmykids}.

La figure~\ref{fig:findmykids} présente l'interface utilisateur de l'application FindMyKids, étudiée dans le cadre de l'analyse des solutions existantes de géolocalisation et de suivi des enfants.
\begin{figure}[H]
    \centering
...
\noindent\textbullet\ \textbf{Life360}

Application de suivi familial qui partage la position des membres en temps réel, facilite la communication entre eux et inclut des fonctionnalités de géorepérage. Elle est largement utilisée pour coordonner la sécurité des membres de la famille, notamment des enfants et des seniors \cite{life360}.

La figure~\ref{fig:life360} illustre l'interface utilisateur de l'application Life360, analysée dans le cadre de l'étude de l'existant.
\begin{figure}[H]
    \centering
...
\noindent\textbullet\ \textbf{Mobile Tracker}

Mobile Tracker est une application de géolocalisation permettant le suivi en temps réel des personnes dépendantes, avec des fonctionnalités de zones sécurisées et d'alertes d'urgence, visant à renforcer la sécurité des utilisateurs \cite{mobiletracker}.

La figure~\ref{fig:mobiletracker} illustre l'interface utilisateur de l'application Mobile Tracker, analysée dans le cadre de l'étude de l'existant.
...
\noindent\textbullet\ \textbf{FamiSafe}
FamiSafe offre un suivi GPS en temps réel, la définition de zones sécurisées, et des alertes aux parents. Elle permet également de contrôler l'accès aux applications et de surveiller certaines activités numériques \cite{famisafe}.


La figure~\ref{fig:safeWatch} illustre l'interface utilisateur de l'application FamiSafe, analysée dans le cadre de l'étude de l'existant.
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|m{3cm}|m{3cm}|m{3cm}|m{3cm}|}
        ...
        & \textbf{FindMyKids} 
        & \textbf{Life360} 
        & \shortstack{\textbf{Mobile}\\\textbf{Tracker}} \\
        \hline
...
\begin{itemize}
    \item \colorbox{green!20}{$\checkmark$} : Fonctionnalité disponible / avantage
    \item \colorbox{yellow!20}{Limité} : Fonctionnalité disponible de manière limitée
    \item \colorbox{red!20}{$\times$} : Fonctionnalité non disponible ou limitation majeure
\end{itemize}
...
\begin{longtable}{|c|p{6.8cm}|c|p{5cm}|}
    ...
    détection entrée/sortie de zones de sécurité &
    3 semaines &
    Module tracking temps réel, cartes interactives, gestion des zones de sécurité \\
    \hline
