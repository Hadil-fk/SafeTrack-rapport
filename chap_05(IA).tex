...
\begin{itemize}
    ...
    \item Données comportementales issues des capteurs de l'appareil (accéléromètre, gyroscope)
\end{itemize}

\subsection{Données comportementales et sécurité de conduite}
...
\begin{itemize}
    \item \textbf{Détection d'accident :} identification automatique d'un impact soudain ou d'une immobilisation anormale suite à un choc, déclenchant une alerte prioritaire.
    \item \textbf{Sécurité de conduite (Driving Safety) :} analyse du comportement global de déplacement pour évaluer si la trajectoire est cohérente avec le contexte (zone scolaire, heure, vitesse).
    \item \textbf{Freinage brusque (High Braking) :} détection des décélérations brutales indiquant un danger potentiel ou une situation d'urgence imminente.
    \item \textbf{Accélération anormale :} repérage des variations de vitesse inhabituelles pouvant signaler un comportement à risque.
\end{itemize}
...
% Mobile interfaces: daily report and AI card
\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.45\textwidth}
        \vspace{0pt}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=8cm, keepaspectratio]{images/aidailyrapport.jpg}}
        \caption{Interface Mobile — Rapport journalier IA}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \vspace{0pt}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=8cm, keepaspectratio]{images/aicard.jpg}}
        \caption{Interface Mobile — Carte IA}
    \end{minipage}
\end{figure}
% Mobile interface: AI dashboard
\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.45\textwidth}
        \vspace{0pt}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=8cm, keepaspectratio]{images/aidashboard.jpg}}
        \caption{Interface Mobile — Tableau de bord IA}
    \end{minipage}
\end{figure}
