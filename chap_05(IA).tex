...
\hline
US1 & En tant que parent, je souhaite recevoir des alertes intelligentes lorsque mon enfant entre dans une zone dangereuse... & 
...
Lorsqu’un enfant quitte une zone sécurisée définie par les parents durant une période nocturne, le système détecte automatiquement une anomalie et génère une alerte intelligente contenant :
...
\begin{quote}
« Déplacement inhabituel détecté en dehors de la zone sécurisée pendant la nuit. Il est recommandé de vérifier immédiatement la situation et de contacter l’enfant si nécessaire. »
\end{quote}
