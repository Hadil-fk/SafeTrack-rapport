...
Les sprints 1 et 2 ont constitué une étape fondamentale dans le développement de l’application SafeTrack, en mettant en place les fonctionnalités essentielles liées à l’authentification et à la gestion des utilisateurs. Cette première phase a permis d’établir une base solide garantissant un accès sécurisé à la plateforme ainsi qu’une gestion fiable des comptes utilisateurs.

L’implémentation du système d’authentification, accompagnée de la gestion des sessions, assure la protection des données personnelles et contrôle l’accès aux différentes fonctionnalités de l’application. L’intégration de mécanismes de sécurité, tels que la validation des données et l’utilisation de tokens (JWT), renforce la fiabilité du système et garantit une expérience utilisateur sécurisée.

Par ailleurs, le module de gestion du profil permet aux utilisateurs de consulter et de modifier leurs informations personnelles, ainsi que de gérer leurs contacts de confiance. Cette fonctionnalité est particulièrement importante dans le cadre de SafeTrack, car elle facilite la mise en place des mécanismes d’alerte et de notification destinés aux proches en cas de besoin.

Ces développements initiaux constituent le socle technique de l’application et préparent efficacement les prochaines étapes du projet, notamment l’intégration des fonctionnalités avancées telles que le suivi en temps réel, les zones sécurisées et le système d’alertes. Ils démontrent ainsi la capacité à construire une architecture évolutive, sécurisée et adaptée aux objectifs du projet SafeTrack.
