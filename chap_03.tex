﻿
\chapter{Sprint 1\&2 : Authentification, Gestion des comptes, Profils, Utilisateurs et Appareils}
\minitoc
\newpage
...
Acteurs & Utilisateur (Parent / personne dépendantee), Administrateur \\ \hline
...
US-018 & En tant que parent/aidant/organisation, je peux gérer les appareils afin d'associer, dissocier et configurer les dispositifs de suivi.
& \begin{minipage}[t]{\linewidth}\setlength{\itemsep}{-2pt}
\begin{itemize}[leftmargin=*]
...
Le cas d'utilisation \og Ajouter une Personne Dépendant \fg{} est présenté ci—‘dessous. Cette description couvre l'ensemble des opérations permettant aux parents/aidants de créer un profil pour un personne dépendante ou une personne dépendante et de générer automatiquement ses identifiants d'accès.
...
Postcondition & Un nouveau profil Personne Dépendante est créé avec un compte d'accès généré. Les identifiants sont transmis au parent/aidant par email. Le profil est lié au compte du parent et enregistré dans la base de données. \\ \hline
...
\item Le nouvel Personne Dépendante est enregistré et lié au compte du parent.
\item Le système envoie un email au parent contenant l'adresse email et le mot de passe temporaire du compte de l'personne dépendante.
...
\begin{itemize}
    ...
    \item \textbf{Réinitialisation du mot de passe :} Si le parent n'a pas reçu l'email initial ou souhaite générer un nouveau mot de passe, il peut accéder à l'option « Réinitialiser le mot de passe » depuis la fiche de la personne dépendante. Un nouveau mot de passe temporaire est généré et envoyé par email au parent.
