...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth, height=0.9\textheight]{images/Sq_auth.png}
...
\setlength{\parskip}{0pt}
\begin{longtable}{|p{0.25\textwidth}|>{\raggedright\arraybackslash}p{0.70\textwidth}|}
\caption{Description textuelle du cas d'utilisation S'inscrire} \\ \hline
\textbf{Élément} & \textbf{Description} \\ \hline
\endfirsthead
...
Précondition & L'utilisateur est authentifié avec les droits nécessaires. \\ \hline

Postcondition & Modifications enregistrées et confirmation affichée. \\ \hline

Scénario nominal &
\vspace{-0.4em}
\begin{itemize}[nosep, topsep=0pt, partopsep=0pt, leftmargin=*]
\item Accès au profil
\item Affichage du formulaire
\item Modification des champs
\item Ajout/modification photo
\item Validation des données
\item Confirmation
\item Enregistrement
\item Message de succès
\end{itemize}
\vspace{-0.6em}
\\ \hline
...
\textbf{1. Profil personne dépendante :}
\begin{itemize}[nosep, topsep=0pt, leftmargin=*]
\item Sélection
\item Modification
\item Mise à jour permissions
\item Enregistrement
\end{itemize}
...
\begin{itemize}[nosep, topsep=0pt, leftmargin=*]
\item Upload
\item Vérification format/taille
\item Remplacement
\end{itemize}

\textbf{3. Restrictions :}
\begin{itemize}[nosep, topsep=0pt, leftmargin=*]
\item Accès limité
\item Champs protégés
\end{itemize}

\textbf{4. Erreurs :}
\begin{itemize}[nosep, topsep=0pt, leftmargin=*]
\item Données invalides
\item Message d’erreur
\item Correction
\end{itemize}

\textbf{5. Token invalide :}
\begin{itemize}[nosep, topsep=0pt, leftmargin=*]
\item Vérification JWT
\item Rejet
\item Redirection
\end{itemize}

\textbf{6. Accès refusé :}
\begin{itemize}[nosep, topsep=0pt, leftmargin=*]
\item Vérification droits
\item Blocage
\end{itemize}
