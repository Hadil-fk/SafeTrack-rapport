...
En revanche, les personnes dépendantes disposent uniquement d'un accès limité en consultation, sans possibilité de modifier leur profil ou de gérer des contacts.
...
Acteurs & Parent, Aidant, Organisation, Personne Dépendant \\ \hline
...
Scénario nominal &
\begin{itemize}
\item L'utilisateur accède à son espace profil ou sélectionne un Personne Dépendant.
...
Scénario alternatif &
\begin{itemize}
\item \textbf{Modification du profil d'un Personne Dépendant :}
\begin{itemize}
...
\begin{itemize}
\item Personne Dépendant avec accès lecture seule sur son propre profil.
...
\subsubsection{Cas d'utilisation : Ajouter un Personne Dépendant}

Le cas d'utilisation \og Ajouter un Personne Dépendant \fg{} est présenté ci—‘dessous. Cette description couvre l'ensemble des opérations permettant aux parents/aidants de créer un profil pour un enfant ou une personne dépendante et de générer automatiquement ses identifiants d'accès.

\small
\renewcommand{\arraystretch}{1.1}
\setlength{\parskip}{0pt}
\begin{longtable}{|p{0.25\textwidth}|>{\raggedright\arraybackslash}p{0.70\textwidth}|}
\caption{Description textuelle du cas d'utilisation Ajouter un Personne Dépendant} \\
\hline
\textbf{Élément} & \textbf{Description} \\ \hline
\endfirsthead
...
Cas d'utilisation & Ajouter un Personne Dépendant \\ \hline
...
Postcondition & Un nouveau profil Personne Dépendant est créé avec un compte d'accès généré. Les identifiants sont transmis au parent/aidant par email. Le profil est lié au compte du parent et enregistré dans la base de données. \\ \hline

Scénario nominal &
\begin{itemize}
\item L'utilisateur (parent/aidant) accède au module de gestion des enfants.
\item L'utilisateur clique sur le bouton « Ajouter un Personne Dépendant ».
...
\item Le nouvel Personne Dépendant est enregistré et lié au compte du parent.
...
\subsubsection{Diagramme de séquence de \og Ajouter un Personne Dépendant \fg}
...
\subsubsection{Réalisation du cas d'utilisation : Ajouter un Personne Dépendant}
...
% Adjusted figures: smaller heights and fixed placement to keep interfaces near the section
\begin{figure}[H]
    \centering
    \begin{minipage}[b]{0.32\textwidth}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=7cm]{images/signup1.jpg}}
        \caption{Interface Mobile —“ Inscription SafeTrack —“ étape 1}
    \end{minipage}%
    \hfill
    \begin{minipage}[b]{0.32\textwidth}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=7cm]{images/signup2.jpg}}
        \caption{Interface Mobile —“ Inscription SafeTrack —“ étape 2}
    \end{minipage}%
    \hfill
    \begin{minipage}[b]{0.32\textwidth}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=7cm]{images/signin.jpg}}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.31\textwidth}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=7cm]{images/modif profil.jpg}}
        \caption{Interface mobile - Modifier Profil}
    \end{minipage}%
    \hfill
    \begin{minipage}[b]{0.31\textwidth}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=7cm]{images/profile.jpg}}
        \caption{Interface Mobile —“ Voir Profil}
    \end{minipage}%
    \hfill
    \begin{minipage}[b]{0.31\textwidth}
        \centering
        \fbox{\includegraphics[width=\linewidth, height=7cm]{images/addchild.jpg}}
        \caption{Interface mobile —“ Ajouter un Personne Dépendant}
    \end{minipage}
\end{figure}
\section*{Conclusion}
