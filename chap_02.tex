...
\textbf{Aidant / Parent :}
\begin{itemize}
    \item Visualiser la position en temps réel de l'enfant ou de la personne dépendante
    \item Définir et gérer des zones sécurisées
    \item Accéder à l'historique de déplacements de l'enfant ou de la personne dépendante sous sa responsabilité
    \item Recevoir des notifications et des alertes SOS
\end{itemize}

\textbf{Personne Dépendant (Enfant, Personne à‚gée) :}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Consulter l'historique de déplacements de l'enfant ou de la personne dépendante sous sa responsabilité
    \item Recevoir des notifications et des alertes SOS
    \item Passer automatiquement des appels d'urgence aux contacts de confiance en cas d'alerte
\end{itemize}

\subsection*{Pour le Personne Dépendant (Enfant, Personne à‚gée)}
\begin{itemize}
    \item Visualiser leur propre position en temps réel
...
La géolocalisation en temps réel constitue une fonctionnalité centrale de SafeTrack. L'application mobile envoie régulièrement la position GPS de l'utilisateur au serveur, qui la stocke et la transmet aux utilisateurs autorisés via l'application mobile ou le dashboard web. Cela permet aux parents ou aux responsables de suivre les déplacements des personnes dépendantes de manière sécurisée.
